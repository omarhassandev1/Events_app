...
class CategoryModel {
  ...
  static List<CategoryModel> get categories => [
    ...
    CategoryModel(id: 4, title: 'Meeting', icon: Icons.meeting_room,image: Assets.images.eventMeating.path),
    CategoryModel(id: 5, title: 'Workshop', icon: Icons.handyman,image: Assets.images.eventWorkshop.path),
    CategoryModel(id: 6, title: 'Eating', icon: Icons.dining,image: Assets.images.eventEating.path),
  ];
}
